...
extern "C"
int KSECRETS_STORE_EXPORT kss_derive_keys(const char* salt, const char* password, char* encryption_key, char* mac_key, size_t keySize)
{
    gpg_error_t gcryerr;
...
extern "C"
int KSECRETS_STORE_EXPORT kss_store_keys(const char* encryption_key, const char* mac_key, size_t keySize)
{
    key_serial_t ks;
